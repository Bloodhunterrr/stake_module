        ...
        <div className="space-y-3">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 items-center px-4 md:px-0">
                ...
                <Select value={selectedCurrencies}
                    ...
                    <SelectTrigger className={"h-8!  w-full  rounded-none py-0 bg-transparent hover:bg-transparent   placeholder:text-white! border-none text-accent"}>
                ...
                <Select value={selectedTransactionTypes[0] ?? ""}
                    ...
                    <SelectContent className="border-none bg-background rounded-none">
                        {transactionTypeOptions.map((opt) => (
                            <SelectItem key={opt.value} value={opt.value} className={'focus:text-background text-accent rounded-none'}>
                                {opt.label}
                            </SelectItem>
                        ))}
                    </SelectContent>
                                    ...
                                    {txs.map((trx) => {
                                        return (
                                            <TableRow key={trx.id}
                                                ...
                                                <TableCell>
                                                    {date},{format(new Date(trx.created_at), "HH:mm")}
                                                </TableCell>
