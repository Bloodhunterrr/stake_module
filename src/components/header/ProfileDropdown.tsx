            ...
            <DropdownMenuContent sideOffset={
                    isNoCategoryOrSportsbook && !isDesktop
                        ...
                        : showBalance
                            ? 10
                            : 5
                } className="lg:w-96 w-screen min-w-90 max-[380px]:min-w-full mt-2 max-[768px]:mt-6 p-0 bg-white rounded-lg rounded-tl-none rounded-tr-none pb-2"
                align="end"
                forceMount>
                ...
                <Tabs defaultValue="profile" className="w-full">
                    ...
                    <TabsContent value="profile">
                        ...
                        <DropdownMenuItem className="w-full border-t rounded-none px-2 py-2 cursor-pointer text-black/70 hover:bg-black/10"
                    ...
                    <TabsContent value="preferences">
                        ...
                        <div className="flex h-14 items-center justify-between border-t border-[#f8f9fa]/40 px-2">
                            ...
                            <button onClick={toggleShowBalance} className={`w-10 h-5 rounded-full transition-colors duration-200 ${
