                                            ...
                                            <Fragment key={ticket.id}>
                                                <TableRow
                                                    ...
                                                    <TableCell className="flex justify-end items-center gap-2">
                                                        {
                                                            label.includes("Lost") ? <Trans>Lost</Trans> :
                                                                label.includes("Returned") ?
                                                                    <span className={'space-x-1'}>
                                                                        <span><Trans>Cashout</Trans></span>
                                                                        <span>{
                                                                    ...
                                                                    : label.includes("Pending") ? <Trans>Pending</Trans> :
                                                         <span>
                                                    ...
                                                    <TableRow className="bg-muted p-0">
                                                        <TableCell colSpan={3} className="p-0">
                                                            <div className="text-sm">
                                                                {ticket.details?.odds?.map((odd: Odd) => {
                                                                    ...
                                                                    return (
                                                                        <div key={odd.id}
                                                                            ...
                                                                            <div
                                                                                className="flex items-center gap-2 px-4 py-1 relative z-10">
                                                                        <span
                                                                ...
                                                                <div
                                                                    className="grid px-4 pb-4 grid-cols-3 gap-2 pt-2 text-xs">
                                                                    <div>
